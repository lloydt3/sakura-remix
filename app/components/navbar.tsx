...
export default function Navbar() {
  ...
  return (
    <div className="flex h-14 items-center justify-center gap-5">
            ...
            className={({ isActive, isPending }) =>
              isPending
                ...
                : isActive
                  ...
                  : "rounded-md px-2 py-1 transition-all duration-200 hover:shadow-md active:shadow-sm shadow-sm shadow-sky-300/20 hover:shadow-sky-300/20"
            }
            to="/"
          >
            Home
